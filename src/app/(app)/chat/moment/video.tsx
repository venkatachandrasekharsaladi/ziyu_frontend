/**
 * ROUTE  /chat/moment/video   —   Video Moment — the in-call screen (visual shell, no camera)
 *
 ...
 *
 *   Layout & components   src/modules/module-03-chat/screens/VideoMomentScreen.tsx
