/**
 * ROUTE  /settings/home-layout   —   M05-S14 · Settings → Home Layout
 *
 ...
 *
 * REACHED FROM: Profile tab -> Preferences -> "Home Layout"
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/HomeLayoutScreen.tsx
 *   Every word on screen  src/copy/settingsHomeLayout.ts
