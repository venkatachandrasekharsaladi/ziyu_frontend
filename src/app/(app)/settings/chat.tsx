/**
 * ROUTE  /settings/chat   —   M05-S11 · Settings → Chat
 *
 ...
 *
 * REACHED FROM: Profile tab -> Preferences -> "Chat"
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/ChatSettingsScreen.tsx
 *   Every word on screen  src/copy/settingsChat.ts
 ...
 */
export { ChatSettingsScreen as default } from '@/modules/module-05-profile/screens/ChatSettingsScreen'
