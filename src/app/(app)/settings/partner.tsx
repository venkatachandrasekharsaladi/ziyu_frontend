/**
 * ROUTE  /settings/partner   —   M05-S04 · Settings → Partner & Pairing
 *
 ...
 *
 * REACHED FROM: Profile tab -> Account -> "Partner & Pairing"
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/PartnerScreen.tsx
 *   Every word on screen  src/copy/invitePartner.ts
 *                         src/copy/settingsPartner.ts
