/**
 * ROUTE  /settings/legal/licenses   —   M05-S22 · Settings → Licenses
 *
 ...
 *
 * REACHED FROM: Profile tab -> About -> "Licenses", or from About
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/LicensesScreen.tsx
 *   Every word on screen  src/copy/settingsLegal.ts
