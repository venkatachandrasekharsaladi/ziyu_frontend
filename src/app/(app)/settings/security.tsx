/**
 * ROUTE  /settings/security   —   M05-S08 · Settings → Security & Sessions
 *
 ...
 *
 * REACHED FROM: Privacy & Security -> the sessions row (NOT on the Profile tab)
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/SecurityScreen.tsx
 *   Every word on screen  src/copy/settingsSecurity.ts
 ...
 */
export { SecurityScreen as default } from '@/modules/module-05-profile/screens/SecurityScreen'
