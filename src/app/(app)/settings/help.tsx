/**
 * ROUTE  /settings/help   —   M05-S18 · Settings → Help & FAQ
 *
 ...
 *
 * REACHED FROM: Profile tab -> Support -> "Help & FAQ"
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/HelpScreen.tsx
 *   Every word on screen  src/copy/settingsHelp.ts
