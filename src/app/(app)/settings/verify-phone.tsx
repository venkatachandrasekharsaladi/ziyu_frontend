/**
 * ROUTE  /settings/verify-phone   —   M05-S03 · Settings → Verify Phone
 *
 ...
 *
 * REACHED FROM: Personal Details -> the verify-phone action (NOT on the Profile tab)
 *
 * TO CHANGE WHAT YOU SEE, EDIT THESE — not this file:
 *
 *   Layout & components   src/modules/module-05-profile/screens/VerifyPhoneScreen.tsx
 *   Every word on screen  src/copy/settingsVerifyPhone.ts
 ...
 */
export { VerifyPhoneScreen as default } from '@/modules/module-05-profile/screens/VerifyPhoneScreen'
