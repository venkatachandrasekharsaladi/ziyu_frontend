/**
 * ROUTE  /sign-up   —   M00-S03 · Create Account
 *
 ...
 *
 *   Layout & components   src/modules/module-00-auth/screens/CreateAccountScreen.tsx
 *   Every word on screen  src/copy/createAccount.ts
 *                         src/copy/errors.ts
