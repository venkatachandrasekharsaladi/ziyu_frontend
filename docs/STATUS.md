# LoveOS — build status and open decisions

**Last updated:** 2026-09-01

The standing answer to "where is this, and what is waiting on me?" Everything
here is verified against the code, not remembered. Where something is unproven,
it says so.

Companion documents:

- `docs/research/couples-app-strategy.md` — market and evidence research, and a
  prioritised recommendation
- `docs/qa/chat-test-cases.md` — 83 test cases, plus the design divergences
- `docs/superpowers/specs/` and `docs/superpowers/plans/` — per-cluster design
  contracts and implementation plans
