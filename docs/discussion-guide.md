...
|---|---|---|
| Whoever owns product | [`product/strengths-and-weaknesses.md`](product/strengths-and-weaknesses.md) §4 and [`product/blind-spots.md`](product/blind-spots.md) §12 | What is broken and what we are not thinking about |
| Whoever owns frontend | [`audit/`](audit/) (three files) | What is cheap to fix now versus what needs the backend |
| Whoever owns strategy | [`research/shortlist.md`](research/shortlist.md) + [`research/couples-real-problems.md`](research/couples-real-problems.md) §1 | Which problems are worth solving at all |
