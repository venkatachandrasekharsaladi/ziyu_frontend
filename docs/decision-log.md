...
| A14 | **Research and suggest** | "use another agent for go through the entire app and analyse all the resources, researchs, use real cases and suggest me" | [`docs/research/couples-app-strategy.md`](research/couples-app-strategy.md), 729 lines with sources. |
